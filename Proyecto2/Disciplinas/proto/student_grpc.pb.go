...
const (
	Student_GetStudentReq_FullMethodName = "/student_grpc.Student/GetStudentReq"
)
...
type StudentClient interface {
	GetStudentReq(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentResponse, error)
}
...
func (c *studentClient) GetStudentReq(ctx context.Context, in *StudentRequest, opts ...grpc.CallOption) (*StudentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StudentResponse)
	err := c.cc.Invoke(ctx, Student_GetStudentReq_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StudentServer interface {
	GetStudentReq(context.Context, *StudentRequest) (*StudentResponse, error)
...
func (UnimplementedStudentServer) GetStudentReq(context.Context, *StudentRequest) (*StudentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStudentReq not implemented")
}
...
func _Student_GetStudentReq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StudentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StudentServer).GetStudentReq(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Student_GetStudentReq_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServer).GetStudentReq(ctx, req.(*StudentRequest))
	}
...
var Student_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "student_grpc.Student",
	HandlerType: (*StudentServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetStudentReq",
			Handler:    _Student_GetStudentReq_Handler,
		},
	},
